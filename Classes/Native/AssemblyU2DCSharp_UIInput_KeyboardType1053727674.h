...
struct  KeyboardType_t1053727674 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(KeyboardType_t1053727674, ___value___1)); }
