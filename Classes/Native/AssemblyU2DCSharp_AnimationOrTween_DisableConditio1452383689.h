...
struct  DisableCondition_t1452383689 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DisableCondition_t1452383689, ___value___1)); }
