...
struct  AspectRatioSource_t788096023 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AspectRatioSource_t788096023, ___value___1)); }
