...
struct  JSHighlighterController_t3018151188  : public MonoBehaviour_t667441552
{
public:
...
public:
	inline static int32_t get_offset_of_h_2() { return static_cast<int32_t>(offsetof(JSHighlighterController_t3018151188, ___h_2)); }
