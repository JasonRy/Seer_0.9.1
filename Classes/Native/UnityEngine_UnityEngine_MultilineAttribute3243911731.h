...
struct  MultilineAttribute_t3243911731  : public PropertyAttribute_t3531521085
{
public:
...
public:
	inline static int32_t get_offset_of_lines_0() { return static_cast<int32_t>(offsetof(MultilineAttribute_t3243911731, ___lines_0)); }
