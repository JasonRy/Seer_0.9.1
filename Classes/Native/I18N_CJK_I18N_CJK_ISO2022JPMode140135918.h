...
struct  ISO2022JPMode_t140135918 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ISO2022JPMode_t140135918, ___value___1)); }
