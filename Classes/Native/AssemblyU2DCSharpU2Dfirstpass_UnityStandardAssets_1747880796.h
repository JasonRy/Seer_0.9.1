...
struct  IntensitySettings_t1747880796 
{
public:
...
public:
	inline static int32_t get_offset_of_reflectionMultiplier_0() { return static_cast<int32_t>(offsetof(IntensitySettings_t1747880796, ___reflectionMultiplier_0)); }
	...
	inline static int32_t get_offset_of_fadeDistance_1() { return static_cast<int32_t>(offsetof(IntensitySettings_t1747880796, ___fadeDistance_1)); }
	...
	inline static int32_t get_offset_of_fresnelFade_2() { return static_cast<int32_t>(offsetof(IntensitySettings_t1747880796, ___fresnelFade_2)); }
	...
	inline static int32_t get_offset_of_fresnelFadePower_3() { return static_cast<int32_t>(offsetof(IntensitySettings_t1747880796, ___fresnelFadePower_3)); }
...
#endif
// Native definition for marshalling of: UnityStandardAssets.CinematicEffects.ScreenSpaceReflection/IntensitySettings
struct IntensitySettings_t1747880796_marshaled_pinvoke
{
	float ___reflectionMultiplier_0;
	float ___fadeDistance_1;
	float ___fresnelFade_2;
...
// Native definition for marshalling of: UnityStandardAssets.CinematicEffects.ScreenSpaceReflection/IntensitySettings
struct IntensitySettings_t1747880796_marshaled_com
{
	float ___reflectionMultiplier_0;
	float ___fadeDistance_1;
	float ___fresnelFade_2;
