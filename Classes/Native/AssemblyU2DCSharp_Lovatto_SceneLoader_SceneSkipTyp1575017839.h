...
struct  SceneSkipType_t1575017839 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(SceneSkipType_t1575017839, ___value___1)); }
