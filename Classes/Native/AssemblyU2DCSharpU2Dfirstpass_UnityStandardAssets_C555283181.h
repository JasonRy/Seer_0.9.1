...
struct  ConsoleSettings_t555283181 
{
public:
...
public:
	inline static int32_t get_offset_of_subpixelSpreadAmount_0() { return static_cast<int32_t>(offsetof(ConsoleSettings_t555283181, ___subpixelSpreadAmount_0)); }
	...
	inline static int32_t get_offset_of_edgeSharpnessAmount_1() { return static_cast<int32_t>(offsetof(ConsoleSettings_t555283181, ___edgeSharpnessAmount_1)); }
	...
	inline static int32_t get_offset_of_edgeDetectionThreshold_2() { return static_cast<int32_t>(offsetof(ConsoleSettings_t555283181, ___edgeDetectionThreshold_2)); }
	...
	inline static int32_t get_offset_of_minimumRequiredLuminance_3() { return static_cast<int32_t>(offsetof(ConsoleSettings_t555283181, ___minimumRequiredLuminance_3)); }
...
#endif
// Native definition for marshalling of: UnityStandardAssets.CinematicEffects.FXAA/ConsoleSettings
struct ConsoleSettings_t555283181_marshaled_pinvoke
{
	float ___subpixelSpreadAmount_0;
	float ___edgeSharpnessAmount_1;
	float ___edgeDetectionThreshold_2;
...
// Native definition for marshalling of: UnityStandardAssets.CinematicEffects.FXAA/ConsoleSettings
struct ConsoleSettings_t555283181_marshaled_com
{
	float ___subpixelSpreadAmount_0;
	float ___edgeSharpnessAmount_1;
	float ___edgeDetectionThreshold_2;
